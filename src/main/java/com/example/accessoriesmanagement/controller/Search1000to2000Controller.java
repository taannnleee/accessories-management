...
@WebServlet(name = "SearchAjaxPrice1000to2000ShopControl", urlPatterns = {"/product1to2"})
public class Search1000to2000Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = productDao.getProduct1000to2000();
