...
@WebServlet(name = "SearchAjaxPriceOver2000ShopControl", urlPatterns = {"/product2000"})
public class Search2000Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = productDao.getProductOver2000();
