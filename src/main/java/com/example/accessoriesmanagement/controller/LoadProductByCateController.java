...
@WebServlet(name = "CategoryShopControl", urlPatterns = {"/loadCate"})
public class LoadProductByCateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Long cateID = Long.valueOf(request.getParameter("cid"));
        //da lay dc category id ve roi
        List<Product> list = productDao.getProductById(cateID);
        //in list p day
