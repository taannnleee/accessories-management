...
@WebServlet(name = "SearchMinToMaxShopControl", urlPatterns = {"/searchMinToMax"})
public class SearchMintoMaxController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = productDao.getProductMinToMax(priceMinValue, priceMax);
