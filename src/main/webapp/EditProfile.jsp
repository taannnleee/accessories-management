...
<div id="logreg-forms">
    <form class="form-signin" action="editProfile" method="post">
        ...
        <input name="dateOfBirth" type="text" id="dateOfBirth" class="form-control" value="${sessionScope.acc.dateOfBirth }" required="" autofocus="">
        <label for="email">Email</label>
        <input name="email" type="text" id="email" class="form-control" value="${sessionScope.acc.email }" required="" autofocus="">
        <label for="firstName">First name</label>
        <input name="firstName" type="text" id="firstName" class="form-control" value="${sessionScope.acc.firstName }" required="" autofocus="">
        <label for="lastName">Last name</label>
        <input name="lastName" type="text" id="lastName" class="form-control" value="${sessionScope.acc.lastName }" required="" autofocus="">
