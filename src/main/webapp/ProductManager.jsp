            ...
            <table class="table table-hover text-nowrap">
              ...
              <c:forEach items="${listP}" var="o">
                <tr>
                  ...
                  <td>
                    <a href="loadProduct?pid=${o.productID}"><button type="button" class="btn btn-warning"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></button></a>
                    <a href="delete_product?pid=${o.productID}"><button type="button" class="btn btn-danger"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button></a>
                  </td>
                </tr>
              </c:forEach>
              </tbody>
